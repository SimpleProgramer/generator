...
public class ModelAndExampleBaseClassPlugin extends PluginAdapter {
    ...
    private String baseModelSuperClassName = "com.scxxwb.net.mapper.BaseModel";

    /**
     * Example的基类
     */
    private String baseExampleSuperClass = "BaseModelExample";
    private String baseExampleSuperClassName = "com.scxxwb.net.mapper.BaseModelExample";

    /**
     * Criteria的基类
     */
    private String baseCriteriaSuperClass = "BaseCriteria";
    private String baseCriteriaSuperClassName = "com.scxxwb.net.mapper.BaseCriteria";
